...
数据库：DB(DataBase): 数据仓库，软件，安装在操作系统之上
:::
...
2. 非关系型数据库：NoSQL（Not Only SQL）
    1. Redis、MongoDB
    2. 指数据以**对象**的形式存储在数据库中，而对象之间的关系通过每个对象自身的属性来决定
...
1. INNODB:  默认使用，安全性高，支持事务的处理，多表多用户操作
2. MYISAM:  早些年使用，节约空间，速度较快
